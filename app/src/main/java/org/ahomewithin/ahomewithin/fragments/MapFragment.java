...
public class MapFragment extends Fragment implements
    ...
    protected void loadMap(GoogleMap googleMap) {
        if (googleMap != null) {
            // ... use map here
            Toast.makeText(getContext(), "Can do something with map now...", Toast.LENGTH_SHORT).show();
    ...
    */
    ...
    public void onConnected(Bundle dataBundle) {
        ...
        Location location = null;  //LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
        if (location != null) {
